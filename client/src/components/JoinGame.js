...
// const rows = [
//   {player:"selwyn",result:"win"},
//   {player:"tan ah kao",result:"loss"},
//   {player:"selwyn",result:"win"},
//   {player:"tan ah kao",result:"loss"},
//   {player:"selwyn",result:"win"},
//   {player:"tan ah kao",result:"loss"},
...
<div >
      <img role="presentation" src={yourImage} alt="tictactoe" style={{
    position: 'absolute',
    top: '2%',
    left: '42%',
    ...
    width:"400px",  // Adjust the left position as needed
  }} id="outlined-basic" label="Username of opponent" variant="outlined" 
          ...
          <Button  style={{maxWidth: '57px', maxHeight: '56px', minWidth: '120px', minHeight: '56px',position: 'absolute',
    top: '31%',
    left: '65%',
    transform: 'translate(-50%, -50%)'}} 
  variant="contained" onClick={createChannel}> Join Game
  </Button>                                                         {/* BUTTON----------------------------------------------------------------- */}
    ...
    transform: 'translate(-50%, -50%)', }}>
      ...
      <TableContainer sx={{ maxHeight: 440 }}>
        ...
        <caption>This is a table containing information about your previous game results. The first column will be the player name, and the second column will be the game result. Each row represents a game.</caption>
          <TableHead >
            <TableRow >
              {columns.map((column) => (
                <TableCell
          ...
          <TableBody>
            {rows
              ...
              .map((row) => {
                return (
                  <TableRow hover key={row.code} tabIndex={-1} role="row" >
                    {columns.map((column) => {
                      const value = row[column.id];
                      return (
                        <TableCell key={column.id} align={column.align} scope="row" role="cell" >
